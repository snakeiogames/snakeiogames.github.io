(function (scope) {
    var CryptoJS = CryptoJS || function (o) {
        ...
        var e = {}, n = e.lib = {}, i = n.Base = {
            ...
            init: function (e, n) {
                ...
                var n = this.words, t = e.words, i = this.sigBytes;
                if (e = e.sigBytes, this.clamp(), i % 4) for (var r = 0; r < e; r++) n[i + r >>> 2] |= (t[r >>> 2] >>> 24 - r % 4 * 8 & 255) << 24 - (i + r) % 4 * 8; else if (65535 < t.length) for (r = 0; r < e; r += 4) n[i + r >>> 2] = t[r >>> 2]; else n.push.apply(n, t);
            ...
            reset: function () {
                ...
                var n = this._data, t = n.words, i = n.sigBytes, r = this.blockSize, s = i / (4 * r);
    ...
    !function (r) {
        ...
        for (var n = CryptoJS, t = (s = n.lib).WordArray, i = s.Hasher, s = n.algo, a = [], f = [], o = 2, d = 0; d < 64;) {
            ...
            e:{
                l = o;
                for (var u = r.sqrt(l), c = 2; c <= u; c++) if (!(l % c)) {
                    l = !1;
                    break e
                }
                l = !0
        ...
        s = s.SHA256 = i.extend({
            _doReset: function () {
                ...
                for (var t = this._hash.words, i = t[0], r = t[1], s = t[2], a = t[3], o = t[4], d = t[5], l = t[6], u = t[7], c = 0; c < 64; c++) {
                    if (c < 16) m[c] = 0 | e[n + c]; else {
                        var v = m[c - 15], g = m[c - 2];
                ...
                var e = this._data, n = e.words, t = 8 * this._nDataBytes, i = 8 * e.sigBytes;
        ...
        CryptoJS.enc.Base64 = {
            stringify: function (e) {
                var n = e.words, t = e.sigBytes, i = this._map;
                e.clamp(), e = [];
                for (var r = 0; r < t; r += 3) for (var s = (n[r >>> 2] >>> 24 - r % 4 * 8 & 255) << 16 | (n[r + 1 >>> 2] >>> 24 - (r + 1) % 4 * 8 & 255) << 8 | n[r + 2 >>> 2] >>> 24 - (r + 2) % 4 * 8 & 255, a = 0; a < 4 && r + .75 * a < t; a++) e.push(i.charAt(s >>> 6 * (3 - a) & 63));
                if (n = i.charAt(64)) for (; e.length % 4;) e.push(n);
                return e.join("")
            }, parse: function (e) {
                var n = e.length, t = this._map;
                !(i = t.charAt(64)) || -1 != (i = e.indexOf(i)) && (n = i);
                for (var i = [], r = 0, s = 0; s < n; s++) if (s % 4) {
                    var a = t.indexOf(e.charAt(s - 1)) << s % 4 * 2, o = t.indexOf(e.charAt(s)) >>> 6 - s % 4 * 2;
    ...
    !function (e) {
    ...
    }(gameanalytics = gameanalytics || {}), function (e) {
        var n, l, t;
    ...
    }(gameanalytics = gameanalytics || {}), function (m) {
        !function (e) {
            var d = m.logging.GALogger, o = m.utilities.GAUtilities, l = m.events.EGASdkErrorCategory,
                u = m.events.EGASdkErrorArea, c = m.events.EGASdkErrorAction, v = m.events.EGASdkErrorParameter,
            ...
            var n = (f.validateBusinessEvent = function (e, n, t, i, r) {
                ...
                for (var n = 0; n < e.length; ++n) if (!o.stringMatch(e[n], /^[A-Za-z]+$/)) return d.w("resource currencies validation failed: a resource currency can only be A-Z, a-z. String was: " + e[n]), !1;
                return !0
            }, f.validateResourceItemTypes = function (e) {
                if (!f.validateArrayOfStrings(20, 32, !1, "resource item types", e)) return !1;
                for (var n = 0; n < e.length; ++n) if (!f.validateEventPartCharacters(e[n])) return d.w("resource item types validation failed: a resource item type cannot contain other characters than A-z, 0-9, -_., ()!?. String was: " + e[n]), !1;
                return !0
        ...
        !function (e) {
            ...
            e.NameVersion = u;
            var t = (r.touch = function () {
            }, r.getRelevantSdkVersion = function () {
                ...
                var t, i, r, s, a = new u("unknown", "0.0.0"), o = 0, d = 0;
                for (o = 0; o < n.length; o += 1) if (new RegExp(n[o].value, "i").test(e)) {
        ...
        n = e.state || (e.state = {}), r = e.validators.GAValidator, c = e.utilities.GAUtilities, v = e.logging.GALogger, d = e.store.GAStore, s = e.device.GADevice, l = e.store.EGAStore, t = e.store.EGAStoreArgsOperator, g.setUserId = function (e) {
            ...
            var e = c.timeIntervalSince1970(), n = e + g.instance.clientServerTimeOffset;
            ...
            if (e) {
                ...
                for (var r in e) {
                    ...
                    } else u = g.formatString(l = "validateAndCleanCustomFields: entry with key={0}, value={1} has been omitted because it exceeds the max number of custom fields (" + g.MAX_CUSTOM_FIELDS_COUNT + ")", [r, s]), v.w(u), n && n(l, u); else {
                        var l,
                            u = g.formatString(l = "validateAndCleanCustomFields: entry with key={0}, value={1} has been omitted because its key or value is null", [r, s]);
                        v.w(u), n && n(l, u)
                    }
                }
            }
            ...
            var n = g.instance.remoteConfigsListeners.indexOf(e);
            -1 < n && g.instance.remoteConfigsListeners.splice(n, 1)
            ...
            if (n) {
                ...
                for (var t = 0; t < n.length; ++t) {
                    var i = n[t];
                    if (i) {
                        var r = i.key, s = i.value, a = i.start_ts ? i.start_ts : Number.MIN_VALUE,
                            o = i.end_ts ? i.end_ts : Number.MAX_VALUE, d = g.getClientTsAdjusted();
            ...
            var n = g.instance.beforeUnloadListeners.indexOf(e);
            -1 < n && g.instance.beforeUnloadListeners.splice(n, 1)
        ...
        n = e.tasks || (e.tasks = {}), o = e.utilities.GAUtilities, d = e.logging.GALogger, l.execute = function (e, n, t, i) {
            ...
            if (l.timestampMap[n] || (l.timestampMap[n] = r), l.countMap[n] || (l.countMap[n] = 0), 3600 <= (r.getTime() - l.timestampMap[n].getTime()) / 1e3 && (l.timestampMap[n] = r, l.countMap[n] = 0), !(l.countMap[n] >= l.MaxCount)) {
                var s = o.getHmac(i, t), a = new XMLHttpRequest;
        ...
        u = e.http || (e.http = {}), p = e.state.GAState, S = e.logging.GALogger, c = e.utilities.GAUtilities, h = e.validators.GAValidator, A = e.tasks.SdkErrorTask, v = e.events.EGASdkErrorCategory, g = e.events.EGASdkErrorArea, f = e.events.EGASdkErrorAction, m = e.events.EGASdkErrorParameter, y.prototype.requestInit = function (e, n) {
            var t = p.getGameKey(),
                ...
                r = p.getInitAnnotations(), s = JSON.stringify(r);
            if (s) {
                var a = this.createPayloadData(s, this.useGzip), o = [];
            ...
            if (0 != e.length) {
                var i = p.getGameKey(), r = this.baseUrl + "/" + i + "/" + this.eventsUrlPath, s = JSON.stringify(e);
                if (s) {
                    var a = this.createPayloadData(s, this.useGzip), o = [];
            ...
            if (p.isEventSubmissionEnabled() && h.validateSdkErrorEvent(s, a, e, n, t)) {
                var o, d = this.baseUrl + "/" + s + "/" + this.eventsUrlPath, l = "",
                    u = p.getSdkErrorEventAnnotations(), c = y.sdkErrorCategoryString(e);
            ...
            var a = new XMLHttpRequest, o = p.getGameSecret(), d = c.getHmac(o, n), l = [];
            ...
            var a = r ? JSON.parse(r) : {}, o = y.instance.processRequestResponse(s, e.statusText, r, "Init");
        ...
        g = E.events || (E.events = {}), f = E.store.GAStore, m = E.store.EGAStore, p = E.store.EGAStoreArgsOperator, S = E.state.GAState, h = E.logging.GALogger, A = E.utilities.GAUtilities, l = E.http.EGAHTTPApiResponse, y = E.http.GAHTTPApi, b = E.validators.GAValidator, C.customEventFieldsErrorCallback = function (e, n) {
            ...
            if (void 0 === r && (r = null), S.isEventSubmissionEnabled()) {
                ...
                if (null == o) {
                    ...
                    var l = {};
                    if (s && 0 < Object.keys(s).length) for (var u in s) l[u] = s[u]; else for (var u in S.instance.currentGlobalCustomEventFields) l[u] = S.instance.currentGlobalCustomEventFields[u];
                    if (a && s && 0 < Object.keys(s).length) for (var u in S.instance.currentGlobalCustomEventFields) l[u] || (l[u] = S.instance.currentGlobalCustomEventFields[u]);
            ...
            if (S.isEventSubmissionEnabled()) {
                ...
                if (null == o) {
                    ...
                    var d = {}, l = C.resourceFlowTypeToString(e);
                    d.event_id = l + ":" + n + ":" + i + ":" + r, d.category = C.CategoryResource, d.amount = t, C.addDimensionsToEvent(d);
                    var u = {};
                    if (s && 0 < Object.keys(s).length) for (var c in s) u[c] = s[c]; else for (var c in S.instance.currentGlobalCustomEventFields) u[c] = S.instance.currentGlobalCustomEventFields[c];
                    if (a && s && 0 < Object.keys(s).length) for (var c in S.instance.currentGlobalCustomEventFields) u[c] || (u[c] = S.instance.currentGlobalCustomEventFields[c]);
            ...
            if (S.isEventSubmissionEnabled()) {
                var d = C.progressionStatusToString(e), l = b.validateProgressionEvent(e, n, t, i);
                if (null == l) {
                    var u, c = {};
                    ...
                    var g = {};
                    if (a && 0 < Object.keys(a).length) for (var f in a) g[f] = a[f]; else for (var f in S.instance.currentGlobalCustomEventFields) g[f] = S.instance.currentGlobalCustomEventFields[f];
                    if (o && a && 0 < Object.keys(a).length) for (var f in S.instance.currentGlobalCustomEventFields) g[f] || (g[f] = S.instance.currentGlobalCustomEventFields[f]);
            ...
            if (S.isEventSubmissionEnabled()) {
                ...
                if (null == s) {
                    ...
                    var o = {};
                    if (i && 0 < Object.keys(i).length) for (var d in i) o[d] = i[d]; else for (var d in S.instance.currentGlobalCustomEventFields) o[d] = S.instance.currentGlobalCustomEventFields[d];
                    if (r && i && 0 < Object.keys(i).length) for (var d in S.instance.currentGlobalCustomEventFields) o[d] || (o[d] = S.instance.currentGlobalCustomEventFields[d]);
            ...
            if (void 0 === r && (r = !1), S.isEventSubmissionEnabled()) {
                var s = C.errorSeverityToString(e), a = b.validateErrorEvent(e, n);
                if (null == a) {
                    var o = {};
                    if (o.category = C.CategoryError, o.severity = s, o.message = n, C.addDimensionsToEvent(o), !r) {
                        var d = {};
                        if (t && 0 < Object.keys(t).length) for (var l in t) d[l] = t[l]; else for (var l in S.instance.currentGlobalCustomEventFields) d[l] = S.instance.currentGlobalCustomEventFields[l];
                        if (i && t && 0 < Object.keys(t).length) for (var l in S.instance.currentGlobalCustomEventFields) d[l] || (d[l] = S.instance.currentGlobalCustomEventFields[l]);
            ...
            if (S.isEventSubmissionEnabled()) {
                var l = C.adActionToString(e), u = C.adTypeToString(n), c = C.adErrorToString(r),
                ...
                if (null == v) {
                    ...
                    var f = {};
                    if (o && 0 < Object.keys(o).length) for (var m in o) f[m] = o[m]; else for (var m in S.instance.currentGlobalCustomEventFields) f[m] = S.instance.currentGlobalCustomEventFields[m];
                    if (d && o && 0 < Object.keys(o).length) for (var m in S.instance.currentGlobalCustomEventFields) f[m] || (f[m] = S.instance.currentGlobalCustomEventFields[m]);
            ...
            if (S.isEventSubmissionEnabled()) try {
                ...
                for (var d = [], l = 0; l < a.length; ++l) {
                    var u = a[l], c = JSON.parse(A.decode64(u.event));
                    if (0 != c.length) {
                        var v = c.client_ts;
            ...
            var r = [];
            if (r.push(["status", p.Equal, t]), e === l.Ok) f.delete(m.Events, r), h.i("Event queue: " + i + " events sent."); else if (e === l.NoResponse) {
                var s = [];
            ...
            if (S.isEventSubmissionEnabled()) {
                ...
                if (n && 0 != n.length) {
                    ...
                    for (var t = 0; t < n.length; ++t) {
                        var i = JSON.parse(A.decode64(n[t].event)), r = i.client_ts - n[t].timestamp;
                        r = Math.max(0, r), i.category = C.CategorySessionEnd, i.length = r, C.addEventToStore(i)
                    }
                }
            }
        }, C.addEventToStore = function (e) {
            if (S.isEventSubmissionEnabled()) if (S.isInitialized()) try {
                ...
                var r = {status: "new"};
                r.category = n.category, r.session_id = n.session_id, r.client_ts = n.client_ts, r.event = A.encode64(JSON.stringify(n)), f.insert(m.Events, r), e.category == C.CategorySessionEnd ? f.delete(m.Sessions, [["session_id", p.Equal, n.session_id]]) : C.updateSessionStore(), f.isStorageAvailable() && f.save(S.getGameKey())
            } catch (t) {
        ...
        r = e.threading || (e.threading = {}), n = e.logging.GALogger, t = e.state.GAState, i = e.events.GAEvents, a.createTimedBlock = function (e) {
            ...
            try {
                for (var e; e = a.getNextBlock();) if (!e.ignore) if (e.async) {
                    if (!e.running) {
                        e.running = !0, e.block();
                        break
                    }
    ...
    }(gameanalytics = gameanalytics || {}), function (d) {
        var l = d.threading.GAThreading, o = d.logging.GALogger, u = d.store.GAStore, c = d.state.GAState,
            e = d.http.GAHTTPApi, v = d.device.GADevice, i = d.validators.GAValidator, g = d.http.EGAHTTPApiResponse,
            f = d.utilities.GAUtilities, m = d.events.GAEvents, n = (E.getGlobalObject = function () {
                ...
                if (e !== g.Ok && e !== g.Created || !n) e == g.Unauthorized ? (o.w("Initialize SDK failed - Unauthorized"), c.instance.initAuthorized = !1) : (e === g.NoResponse || e === g.RequestTimeout ? o.i("Init call (session start) failed - no response. Could be offline or timeout.") : e === g.BadResponse || e === g.JsonEncodeFailed || e === g.JsonDecodeFailed ? o.i("Init call (session start) failed - bad response. Could be bad response from proxy or GA servers.") : e !== g.BadRequest && e !== g.UnknownResponseCode || o.i("Init call (session start) failed - bad request or unknown response."), null == c.instance.sdkConfig ? null != c.instance.sdkConfigCached ? (o.i("Init call (session start) failed - using cached init values."), c.instance.sdkConfig = c.instance.sdkConfigCached) : (o.i("Init call (session start) failed - using default init values."), c.instance.sdkConfig = c.instance.sdkConfigDefault) : o.i("Init call (session start) failed - using cached init values."), c.instance.initAuthorized = !0); else {
                    var t = 0;
                    if (n.server_ts) {
                        var i = n.server_ts;
